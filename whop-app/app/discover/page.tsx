 ...
 *  They are gone rather than adapted: Clips Kitty has no success stories to
...
export default function DiscoverPage() {
	return (
		<Pitch note="Add Clips Kitty to your community and your clippers get it in their sidebar. Nothing to host and nothing to pay for — each member installs it on their own PC." />
	);
}
