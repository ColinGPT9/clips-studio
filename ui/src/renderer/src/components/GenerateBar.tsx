  ...
  return (
    <div className="space-y-3">
      <div className="card flex gap-3 items-center flex-wrap">
        ...
        <label
          className="flex items-center gap-2 cursor-pointer text-sm shrink-0"
          title="For multi-camera podcasts (cuts between angles, several people). Frames shot by shot: each camera shot gets one steady crop centered on whoever is talking, and cuts land directly on the speaker's face — no panning, no split screens. Leave OFF for normal one-camera streams."
        >
          <input
            type="checkbox"
            className="size-4 accent-[#38BDF8]"
